...
(function(){
  ...
  var DEFAULT_MARK_CONFLICT_RESOLUTIONS = {
    ...
    //   • 78:38 الكلمة 5 ("صَفّٗا"، ط×قد_قيل×لا): طلب مباشر لاحق (1.0.739)
    //     اعتماد ق أخضر — حُسمت QAD_QILA (بدل CONFIRMED_EXCLUDED).
    //   • 11:46 الكلمة 10 ("صَٰلِحٖۖ"، قد_قيل×ز): معاها صلي في مصحف
    //     النسخ — كانت مُستبعدة، ثم اعتُمدت ق أخضر.
    ...
    '78:38:5': 'QAD_QILA',
    // 11:46:10: اعتماد مباشر بعد مراجعة المستخدم (دفعة 1–15) — ق أخضر
    '11:46:10': 'QAD_QILA',
    ...
    '4:103:9': 'JEEM',
    // طلب مباشر 1.0.754: يونس ج→ط أزرق
    '10:98:9': 'TA_MUTLAQ',
    '2:62:18': 'JEEM',
  ...
  var DEFAULT_MARK_MANUAL_EXCLUSIONS = {
    ...
    'TA_MUTLAQ': {'14:9:13': true, '33:13:18': true, '11:49:16': true, '47:4:21': true, '57:19:10': true, '66:2:6': true, '2:187:42': true, '4:11:42': true, '4:25:34': true, '4:135:14': true, '6:89:6': true /* والنبوة ط→ج */, '6:137:17': true /* فعلوه ط→صلي */, '10:27:24': true /* النار ط→ج */, '11:23:11': true /* الجنة ط→ج */, '9:36:25': true /* أنفسكم ط→قف */, '19:29:2': true /* إليه ط→قف */, '19:71:4': true /* واردها ط→ج */, '20:108:6': true /* له ط→ج */, '28:56:10': true /* يشاء ط→ج */, '40:28:24': true /* كذبه ط→ج */, '40:67:20': true /* شيوخا ط→ج */, '40:68:4': true /* يميت ط→ج */, '45:24:12': true /* الدهر ط→ج */, '58:4:10': true /* يتماسا ط→ج */,
      // طلب مباشر 1.0.748: حذف ط من انتقام (آخر كلمة) + رأس دائرة
      '3:4:18': true,
      // طلب مباشر 1.0.749: حذف ط من شهيدا (آخر كلمة) + رأس دائرة
      '4:166:13': true,
      // طلب مباشر 1.0.750: حذف ط من الأرض
      '5:40:8': true},
    ...
    'SAD_RUKHSA': {'24:37:13': true, '91:14:2': true, '55:11:2': true,
      // طلب مباشر 1.0.751: حذف ص من عملهم
      '6:108:17': true},
    ...
    'ZAY_JAWAZ': {
      // '2:168:8' أُزيل من الاستبعاد — طلب مباشر: ز أخضر على طيبا
      '5:22:6': true,
      // '4:140:22' أُزيل من الاستبعاد — طلب مباشر: ز أخضر على غيره
      '5:107:22': true, '7:83:4': true,
      // '6:141:25' أُزيل من الاستبعاد — طلب مباشر: ز أخضر على حصاده
      // '7:151:8' أُزيل من الاستبعاد — طلب مباشر: ز أخضر على رحمتك
      '7:144:8': true, '7:150:30': true,
      '9:129:5': true, '19:48:8': true,
      '21:56:8': true, '21:92:5': true, '25:50:4': true,
      '27:20:7': true, '42:6:8': true, '46:23:5': true,
      // 9:30:21 الله (قاتلهم الله) — طلب مباشر: ز → ج
      '9:30:21': true,
      // طلب مباشر 1.0.745: حذف الوقف السجاوندي (ز) من واستكبر — كانت ق×ز
      '2:34:10': true
      // ملاحظة: 73:20:48 ("ٱللَّهِۖ") كانت هنا (تقاطع ز×صلي)، لكنها حُذفت
      // من هذه القائمة لاعتماد الوقف ز عليها صراحةً — راجع
      // '73:20:48': { ZAY_JAWAZ: true } في DEFAULT_MARK_LA_SILA_OVERRIDES
      // أدناه (دفعة 1.0.675)، بنفس نمط استثناء 29:60:9 وغيره.
    ...
    // هذا الطلب.)
    'QAD_QILA': {
      // لا (مستبعدة نهائيًا؛ 78:38:5 اعتُمدت ق أخضر لاحقًا عبر CONFLICT_RESOLUTIONS + LA_SILA_OVERRIDES)
      // '2:25:31' أُزيل من الاستبعاد — طلب مباشر: ق أخضر على مطهرة
      '2:20:9': true, '2:101:15': true, '30:30:17': true,
      '47:4:11': true,
      // صلي (مستبعدة نهائيًا؛ 37:31:4 أُزيل — طلب مباشر 1.0.739: ق أخضر على ربنا)
      '3:45:9': true, '3:98:7': true, '3:119:12': true,
      '3:173:12': true, '4:62:10': true, '4:101:11': true,
      '4:143:2': true, '6:70:16': true, '6:138:5': true, /* 5:20:15 ملوكا: أُزيل استبعاد ق — طلب مباشر */
      '7:11:9': true, '8:67:14': true, '12:3:10': true,
      '17:79:6': true,
      '18:82:21': true,
      '19:19:5': true, '21:3:4': true, '21:3:6': true,
      '21:17:8': true, '21:63:3': true, '21:87:19': true, '22:17:10': true,
      '23:17:5': true, '23:67:1': true,
      '24:15:12': true, '24:16:11': true,
      '26:35:6': true, '28:9:9': true,
      '29:46:8': true, '29:60:6': true, '30:25:11': true, '30:25:13': true,
      '31:6:12': true, '35:12:3': true, '36:47:18': true,
      // '37:31:4' أُزيل من الاستبعاد — طلب مباشر: ق أخضر على ربنا
      // '39:8:30' أُزيل من الاستبعاد — طلب مباشر: ق أخضر على قليلا
      '39:67:5': true,
      '40:28:3': true, '40:81:2': true, '42:10:13': true, '43:81:5': true,
      '46:12:14': true, '46:17:18': true, '47:35:5': true, '47:35:7': true,
      '50:38:9': true,
      '60:1:35': true, '76:2:6': true,
      // طلب مباشر 1.0.745: حذف الوقف السجاوندي (ق)
      '2:34:10': true, /* واستكبر */
      '2:61:40': true, /* والمسكنة */
      '2:79:5': true,  /* بأيديهم */
      '2:93:14': true, /* وعصينا */
      // طلب مباشر 1.0.747: حذف الوقف السجاوندي (ق)
      '2:150:23': true, /* منهم */
      '2:150:26': true, /* واخشوني */
      '2:217:18': true, /* الحرام */
      '2:238:5': true,  /* الوسطى */
      // طلب مباشر 1.0.749: حذف الوقف السجاوندي (ق) النساء
      '4:63:7': true    /* قلوبهم */
      // '77:23:1' أُزيل من الاستبعاد — طلب مباشر: ق أخضر على فقدرنا
    },
    ...
    'QIF': {
      // لا (مستبعدة نهائيًا)
      // '2:256:4' أُزيل من الاستبعاد — طلب مباشر: قف بني على الدين
      // '6:19:7' أُزيل من الاستبعاد — طلب مباشر: قف بني على الله (قل الله)
      // '14:27:14' أُزيل من الاستبعاد — طلب مباشر 1.0.739: قف بني على الظالمين
      // '16:70:4' أُزيل من الاستبعاد — طلب مباشر 1.0.739: قف بني على يتوفاكم
      '2:251:3': true, '7:128:9': true,
      // صلي (موضع واحد، مستبعد نهائيًا)
      '27:40:23': true,
      // تعانق (مستبعدة نهائيًا؛ 65:10:11 و47:4:20 حُسمتا أزرق
      // ونُقلتا لـDEFAULT_MARK_CONFLICT_RESOLUTIONS أعلاه، فلم تعودا هنا)
      // '40:70:7' أُزيل من الاستبعاد — طلب مباشر 1.0.739: قف بني على رسلنا
      '9:101:8': true, '26:209:1': true,
      '74:40:2': true, '97:5:1': true,
      // 19:1:1 كهيعص — طلب مباشر: حذف أي قف متبقٍ مع حذف ج
      '19:1:1': true,
      // طلب مباشر 1.0.745: حذف الوقف السجاوندي (قف) من الله
      '2:83:9': true,
      // طلب مباشر 1.0.747: حذف الوقف السجاوندي (قف)
      '2:213:4': true,  /* واحدة */
      '2:243:15': true, /* موتوا */
      '2:253:47': true, /* اقتتلوا */
      '2:259:45': true, /* حمارك */
      // طلب مباشر 1.0.748: حذف الوقف السجاوندي (قف) آل عمران
      '3:25:7': true,   /* فيه */
      '3:61:18': true,  /* وانفسكم */
      '3:89:7': true,   /* واصلحوا */
      '3:135:11': true, /* لذنوبهم — قف→ص */
      '3:186:4': true,  /* وانفسكم */
      '3:197:2': true,  /* قليل */
      '3:200:6': true,  /* ورابطوا */
      // طلب مباشر 1.0.749: حذف الوقف السجاوندي (قف) النساء
      '4:27:5': true,   /* عليكم */
      '4:77:45': true,  /* اتقى */
      '4:109:7': true,  /* الدنيا */
      // طلب مباشر 1.0.750: حذف الوقف السجاوندي (قف) المائدة
      '5:3:21': true,   /* ذكيتم */
      '5:110:15': true, /* القدس */
      // طلب مباشر 1.0.752: حذف قف من مفصلات (7:133 لا 134)
      '7:133:9': true,
      // طلب مباشر 1.0.754: حذف قف من النفاق
      '9:101:11': true
    },
    ...
    // (لا/صلي على أحد الطرفين يستبعده تلقائيًا) يحسم 4 منها فورًا —
    // نفس المواضع موجودة أصلًا ضمن قائمة صلي أعلاه (2:2:4، 2:195:9،
    // 7:188:18، 65:10:9)، فلا داعي لتكرارها هنا. موضع واحد
    // (47:4:20) رُوجع وحُسم منفصلًا أزرق بالفعل (راجع
    // DEFAULT_MARK_CONFLICT_RESOLUTIONS). موضع 3:30:9 ("مُّحۡضَرًا") كان
    // مُستبعدًا هنا أيضًا بنفس البند (يحمل صلى في نص النسخ)، لكن استثناء
    // مباشر لاحق من المستخدم أزاله من هذا الاستبعاد — راجع تعليق
    // "استثناء 3:30 المباشر" أسفل الجدول لتفاصيل القرار وموضعه المقابل.
    // UPDATE (طلب مباشر لاحق، تصحيح قرار سابق): 33:13:21 ("بِعَوۡرَةٍۖ")
    // كانت مُستبعدة هنا سابقًا لصالح ط (راجع القرار القديم أدناه في
    // DEFAULT_MARK_MANUAL_ADDITIONS المستند وقتها إلى "علل الوقوف" ص
    // 817). قرار جديد يعتمد على مصحف النسخ مباشرة يُلغي ذلك: مصحف
    // النسخ يضع ج (وقف جائز) عند هذا الموضع تحديدًا، وليس ط — فتبقى ج
    // هنا نشطة (لم تعد مُستبعدة)، وتُزال إضافة ط المقابلة أدناه في
    // DEFAULT_MARK_MANUAL_ADDITIONS. تُلوَّن بالبني في مصحف المدينة
    // (لون ج)، لا بلون ط. الباقي (25 موضعًا) **لا يمكن حسمه تلقائيًا** — الخوارزمية العامة تحتاج معرفة
    ...
    'JEEM': {
      // 4:83:9 به — طلب مباشر: ج → ط
      '4:83:9': true,
      // 6:137:12 دينهم — طلب مباشر: ج → ط
      '6:137:12': true,
      // 16:126:7 به (عوقبتم به) — طلب مباشر: ج → ط
      '16:126:7': true,
      // 19:1:1 كهيعص — طلب مباشر: حذف ج (رأس آية → دائرة)
      '19:1:1': true,
      // 20:1:1 طه — طلب مباشر: حذف ج (رأس آية → دائرة)
      '20:1:1': true,
      // 20:74:8 جهنم — طلب مباشر: ج → ط
      '20:74:8': true,
      // 50:1:1 قٓ — طلب مباشر: ج → قف بني
      '50:1:1': true,
      // 22:53:11 قلوبهم (والقاسية قلوبهم) — طلب مباشر: ج → ط
      '22:53:11': true,
      // 22:72:27 كفروا (الذين كفروا) — طلب مباشر: ج → ط
      '22:72:27': true,
      // 24:53:7 ليخرجن — طلب مباشر: ج → ط
      '24:53:7': true,
      // 40:28:31 يعدكم — طلب مباشر: ج → ط أزرق
      '40:28:31': true,
      // 60:10:26 لهن — طلب مباشر: ج → ط أزرق
      '60:10:26': true,
      // لا (4 مواضع، مستبعدة نهائيًا)
      '3:49:10': true, '3:181:18': true, '4:75:26': true, '29:66:3': true,
      // صلي (50 موضعًا، مستبعدة نهائيًا)
      '2:2:4': true, '2:14:6': true, '2:76:6': true,
      '2:109:11': true, '2:174:26': true,
      '2:180:9': true, '2:195:9': true,
      '2:240:5': true, '2:266:23': true, '3:118:19': true,
      '7:167:16': true, '7:188:18': true,
      // '9:17:14' أُزيل من الاستبعاد — طلب مباشر: ج بني على أعمالهم
      // '12:29:6' أُزيل من الاستبعاد — طلب مباشر: ج بني على لذنبك
      '11:31:27': true, '22:24:5': true, '23:24:20': true,
      '26:154:5': true, '29:41:9': true, '30:7:5': true,
      '34:31:18': true, '36:33:4': true, '36:37:3': true,
      '38:7:6': true,
      '44:49:1': true, '46:17:22': true,
      '48:12:17': true, '65:10:9': true,
      // 33:13:21 لم تعد مُستبعدة هنا — راجع UPDATE أعلاه: ج هي الصحيحة
      // في مصحف النسخ لهذا الموضع، فبقيت نشطة كموضع ج عادي.
      // استثناء 3:30 المباشر (طلب مباشر لاحق، بناءً على مصحف النسخ):
      // زوج التعانق 3:30 كان محسومًا تلقائيًا بالبند 2 (الطرف الأول،
      // الكلمة 9 "مُّحۡضَرًا"، مُستبعد لأنه يحمل صلى أيضًا؛ الطرف الثاني،
      // الكلمة 13 "سُوٓءٖ"، فائز تلقائيًا لخلوّه من صلى). استثناء مباشر
      // من المستخدم يعتمد على مصحف النسخ نفسه يعكس هذا الحسم بالكامل:
      // 3:30:9 ("محضرا") تُعتمد الآن وقفًا جائزًا ج (أُزيلت من قائمة
      // صلي أعلاه)، وتُلوَّن بالبني في مصحف المدينة؛ 3:30:13 ("سوء")
      // تُهمَل الآن بدون تلوين (أُضيفت هنا). استثناء مباشر لهذا الزوج
      // تحديدًا فقط، بلا تغيير في السياسة العامة لحسم التعانق.
      '3:30:13': true,
      // 7:69:13 جعلكم — طلب مباشر: عدم اعتماد ج (مصحف النسخ المطبوع)
      '7:69:13': true,
      ...
      //   • 3 مواضع حُسمت تلقائيًا (البند 2 من الخوارزمية — الطرف الآخر
      ...
      //     الجدول تمامًا): 2:2:5، 2:195:10، 7:188:21. الموضع الرابع من
      //     هذه الأربعة أصلًا (3:30:13 "سُوٓءٖ") أُعيد لاحقًا إلى
      //     الاستبعاد بقرار مباشر مستقل — راجع تعليق "استثناء 3:30
      //     المباشر" أعلاه.
      ...
      '7:163:23': true, '7:172:16': true,
      // '7:92:7' أُزيل من الاستبعاد — طلب مباشر: ج بني على فيها
      '25:32:10': true,
      // '25:59:13' أُزيل من الاستبعاد — طلب مباشر: ج على العرش
      // '33:61:1' أُزيل من الاستبعاد — طلب مباشر: ج بني على ملعونين
      // '84:15:1' أُزيل من الاستبعاد — طلب مباشر: ج بني على بلى
      '28:35:10': true,
      '44:45:1': true, '60:3:7': true, '68:41:3': true,
      // طلب مباشر 1.0.745: حذف الوقف السجاوندي (ج) من بعهدكم
      '2:40:11': true,
      // طلب مباشر 1.0.747: حذف الوقف السجاوندي (ج) من اليم — آخر كلمة
      '2:178:37': true,
      // طلب مباشر 1.0.752: كارهين ج→لا (حذف البني) — آخر كلمة
      '7:88:21': true,
      // طلب مباشر 1.0.754: حذف ج من تروها
      '9:26:12': true
    }
  };

  // 33:13 الكلمة 18 ("عَوۡرَةٞ", الموضع الأول من زوج التعانق) تبقى
  // مُستبعدة أعلاه (DEFAULT_MARK_MANUAL_EXCLUSIONS['TA_MUTLAQ']) —
  // يُهمَل هذا الموضع، بلا تغيير.
  //
  // UPDATE (طلب مباشر لاحق، تصحيح القرار القديم أدناه): كانت إضافة ط
  // عند 33:13 الكلمة 21 ("بِعَوۡرَةٍۖ", الموضع الثاني) مستندة إلى صورة
  // من "علل الوقوف" للسجاوندي (ص 817)، التي تضع ط فوق «بعورة» "لمن لم
  // يقف على «عورة»". تصحيح مباشر لاحق من المستخدم استند إلى مصحف النسخ
  // نفسه (مصدر المشروع المرجعي لعلامات الوقف): مصحف النسخ يضع فعليًا ج
  // (وقف جائز) عند «بعورة»، لا ط. اعتمادًا على مصحف النسخ، أُلغيت إضافة
  // ط هنا نهائيًا (أُزيلت من الجدول أدناه)، وأُلغي استبعاد ج المقابل لها
  // أعلاه في DEFAULT_MARK_MANUAL_EXCLUSIONS['JEEM'] — فيعود الموضع الآن
  // إلى نوعه الأصلي في waqf-positions.js (ج)، ويُلوَّن بالبني (لون ج في
  // مصحف المدينة) بدل لون ط.
  //
  ...
  var DEFAULT_MARK_MANUAL_ADDITIONS = {
    'TA_MUTLAQ': {
      ...
      // 6:137:12 دينهم — طلب مباشر: ج → ط
      '6:137:12': true,
      // 16:126:7 به (عوقبتم به) — طلب مباشر: ج → ط أزرق
      '16:126:7': true,
      // 17:61:8 إبليس (إلا إبليس) — طلب مباشر: وقف مطلق ط أزرق
      '17:61:8': true,
      // 18:29:26 الشراب (بئس الشراب) — طلب مباشر: وقف مطلق ط أزرق
      '18:29:26': true,
      // 19:94:4 عدّا — طلب مباشر: ط أزرق (+ إزالة من no-sajawandi → رأس نجمة)
      '19:94:4': true,
      // 20:74:8 جهنم — طلب مباشر: ج → ط أزرق
      '20:74:8': true,
      // 20:86:13 حسنا (وعدا حسنا) — طلب مباشر: ط أزرق (+ إزالة لا عن رأس غير الكوفيين)
      '20:86:13': true,
      // 20:88:12 فنسي — طلب مباشر: ط أزرق (+ رأس نجمة)
      '20:88:12': true,
      // 22:53:11 قلوبهم (والقاسية قلوبهم) — طلب مباشر: ج → ط أزرق
      '22:53:11': true,
      // 22:72:27 كفروا (الذين كفروا) — طلب مباشر: ج → ط أزرق
      '22:72:27': true,
      // 24:53:7 ليخرجن — طلب مباشر: ج → ط أزرق
      '24:53:7': true,
      // 26:49:14 تعلمون — طلب مباشر: ط أزرق (+ لا→ط على رأس غير الكوفيين)
      '26:49:14': true,
      // 32:12:8 ربهم (عند ربهم) — طلب مباشر: وقف مطلق ط أزرق
      '32:12:8': true,
      // 40:28:31 يعدكم (الذي يعدكم) — طلب مباشر: ج → ط أزرق
      '40:28:31': true,
      // 60:10:26 لهن — طلب مباشر: ج → ط أزرق
      '60:10:26': true,
      // 68:43:4 ذلة — طلب مباشر: ط أزرق
      '68:43:4': true,
      // 95:7:4 بالدين — طلب مباشر: ط أزرق + رأس نجمة
      '95:7:4': true,
    ...
    'JEEM': {
      '46:15:39': true,
      // 7:1:1 المص — طلب مباشر: وقف سجاوندي جائز ج بني في مصحف المدينة
      // (آية المقطعات كلمة واحدة؛ إزالة 7:1 من no-sajawandi-heads → رأس نجمة)
      '7:1:1': true,
      // 9:30:21 الله (قاتلهم الله) — طلب مباشر: ز → ج بني
      '9:30:21': true,
      // 9:74:29 لهم (خيرا لهم) — طلب مباشر: وقف جائز ج بني
      '9:74:29': true,
      // 10:15:25 نفسي (تلقائي نفسي) — طلب مباشر: ج بني
      '10:15:25': true,
      // 10:22:34 الدين (له الدين) — طلب مباشر: ج بني (+ إزالة لا من رأس غير الكوفيين)
      '10:22:34': true,
      // 31:32:9 الدين (مخلصين له الدين) — طلب مباشر: ج بني (+ لا→ج على رأس غير الكوفيين)
      '31:32:9': true,
      // 33:61:1 ملعونين — طلب مباشر: ج بني (كان مستبعدًا لتعانق)
      '33:61:1': true,
      // 84:15:1 بلى — طلب مباشر: ج بني (كان مستبعدًا لتعانق)
      '84:15:1': true,
      // 33:60:19 قليلا — طلب مباشر: ج بني (آخر كلمة في الآية)
      '33:60:19': true,
      // 40:28:24 كذبه (فعليه كذبه) — طلب مباشر: ط → ج بني
      '40:28:24': true,
      // 2:286:43 وارحمنا — طلب مباشر: ج → قف بني.
      // 5:110:42 بإذني (والأبرص بإذني) — طلب مباشر: ج بني
      '5:110:42': true,
      // 5:110:46 بإذني (الموتى بإذني) — طلب مباشر: ج بني
      '5:110:46': true,
      // 7:92:7 فيها — طلب مباشر: ج بني (كان مستبعدًا لتعانق)
      '7:92:7': true,
      // 9:17:14 أعمالهم — طلب مباشر: ج بني (+ تجاوز صلي)
      '9:17:14': true,
      // 12:29:6 لذنبك — طلب مباشر: ج بني (+ تجاوز صلي)
      '12:29:6': true,
      // 29:66:4 وليتمتعوا — طلب مباشر: قف → ج بني
      '29:66:4': true,
      // 40:67:20 شيوخا — طلب مباشر: ط → ج بني
      '40:67:20': true,
      // 40:68:4 يميت — طلب مباشر: ط → ج بني
      '40:68:4': true,
      // 45:24:12 الدهر — طلب مباشر: ط → ج بني
      '45:24:12': true,
      // 58:4:10 يتماسا — طلب مباشر: ط → ج بني
      '58:4:10': true,
      // 10:27:24 النار (أصحاب النار) — طلب مباشر: ط → ج بني
      '10:27:24': true,
      // 19:71:4 واردها — طلب مباشر: ط → ج بني
      '19:71:4': true,
      // 20:86:6 أسفا — طلب مباشر: ج بني (+ إزالة لا عن رأس غير الكوفيين)
      '20:86:6': true,
      // 20:108:6 له (لا عوج له) — طلب مباشر: ط → ج بني
      '20:108:6': true,
      // 32:1:1 الم — طلب مباشر: ج بني + رأس نجمة
      '32:1:1': true,
      // 42:1:1 حم — طلب مباشر: ج بني + رأس نجمة
      '42:1:1': true,
      // 46:1:1 حم — طلب مباشر: ج بني + رأس نجمة
      '46:1:1': true,
      // 24:17:9 مؤمنين — طلب مباشر: ج بني + رأس نجمة
      '24:17:9': true,
      // 24:45:16 رجلين — طلب مباشر: ج بني
      '24:45:16': true,
      // 25:59:13 العرش — طلب مباشر: ج بني (كان مستبعدًا لتعانق)
      '25:59:13': true,
      // 28:56:10 يشاء — طلب مباشر: ط → ج بني
      '28:56:10': true,
      // 11:23:11 الجنة (أصحاب الجنة) — طلب مباشر: ط → ج بني
      '11:23:11': true,
      ...
      '2:255:5': true,
      // 2:89:16 كفروا (علي الذين كفروا) — طلب مباشر: وقف جائز ج بني.
      '2:89:16': true,
      // دفعة 1.0.683 — ط→ج
      '4:11:42': true, // الثلث
      '4:25:34': true, // أخدان
      '4:135:14': true, // والأقربين
      // 6:89:6 والنبوة — طلب مباشر: ط → ج
      '6:89:6': true,
      ...
      // WAQF_REVIEW high-confidence (Indopak = source of truth) — 1.0.191
      '2:72:10': true /* تكتمون — تصحيح رقم الكلمة 1.0.746 (كانت 11 بسبب thin-space) */, '3:48:5': true, '3:152:32': true, '4:171:28': true, '5:110:26': true, '6:161:7': true, '7:160:15': true, '7:187:10': true, '7:189:18': true, '10:15:31': true, '10:83:19': true, '35:43:21': true, '40:45:10': true, '56:23:3': true, '57:12:22': true, '59:9:31': true, '66:4:17': true, '76:11:8': true, '79:16:6': true,
      // Interactive review batch (Host Word chosen visually via the
      // WAQF_REVIEW tool, one entry per approved case) — 1.0.192
    ...
    'QIF': {
      // '3:50:16' أُزيل — طلب مباشر 1.0.748: حذف قف من ربكم
      '4:171:28': true,
      // '6:62:9' أُزيل — طلب مباشر 1.0.751: حذف قف من الحكم
      // was: '6:62:9': true,
      // '7:43:16' أُزيل — طلب مباشر 1.0.752: حذف قف من لهذا
      '7:46:14': true, '11:63:18': true, '28:25:22': true,
      // ط+قف على نفس توكن النسخ → قف
      '2:102:66': true, '59:9:24': true,
      // 9:36:25 أنفسكم (فيهن أنفسكم) — طلب مباشر: ط → قف بني
      '9:36:25': true,
      // 19:29:2 إليه (فأشارت إليه) — طلب مباشر: ط → قف بني
      '19:29:2': true,
      // 50:1:1 قٓ — طلب مباشر: ج → قف بني
      '50:1:1': true,
      // 2:256:4 الدين — طلب مباشر: قف بني (+ تجاوز لا)
      '2:256:4': true,
      // 6:19:7 الله (قل الله) — طلب مباشر: قف بني (+ تجاوز لا)
      '6:19:7': true,
      // 20:21:4 تخف — طلب مباشر: قف بني
      '20:21:4': true,
      // '29:66:4' وليتمتعوا: نُقل من قف → ج (1.0.738)
      // 18:71:1 فانطلقا — طلب مباشر: قف بني
      '18:71:1': true,
      // 18:74:1 فانطلقا — طلب مباشر: قف بني
      '18:74:1': true,
      // 18:77:1 فانطلقا — طلب مباشر: قف بني (موجود خامًا أيضًا)
      '18:77:1': true,
      // 16:70:4 يتوفاكم — طلب مباشر 1.0.739: قف بني (غير موجود في الخام)
      '16:70:4': true,
      // 14:27:14 الظالمين — طلب مباشر 1.0.739: قف بني (موجود خامًا + لا → تجاوز عبر LA_SILA_OVERRIDES)
      '14:27:14': true,
      // 40:70:7 رسلنا — طلب مباشر 1.0.739: قف بني (كان مستبعدًا لتعانق)
      '40:70:7': true,
      // 2:286:43 وارحمنا — طلب مباشر 1.0.744: ج → قف بني.
      '2:286:43': true
    },
    ...
    'ZAY_JAWAZ': {
      ...
      // Interactive review batch (Host Word chosen visually via the
      // WAQF_REVIEW tool, one entry per approved case) — 1.0.192
      // '4:121:3' أُزيل — طلب مباشر 1.0.749: حذف ز من جهنم
      // 2:285:23 وأطعنا — طلب مباشر: ز أخضر
      '2:285:23': true,
      // 6:141:25 حصاده — طلب مباشر: ز أخضر (+ تجاوز صلي)
      '6:141:25': true,
      // 7:151:8 رحمتك — طلب مباشر: ز أخضر (+ تجاوز صلي)
      '7:151:8': true,
      // 10:16:10 به (أدراكم به) — طلب مباشر: ز أخضر
      '10:16:10': true,
      // 4:140:22 غيره — طلب مباشر: ز أخضر (+ تجاوز صلي)
      '4:140:22': true,
      // 2:168:8 طيبا — طلب مباشر: ز أخضر (+ تجاوز صلي)
      '2:168:8': true
    },
    // ق (QAD_QILA) — فجوات WAQF_REVIEW (Indopak U+E01C)
    'QAD_QILA': {
      '59:2:28': true, '59:2:37': true, '59:7:27': true,
      // 43:45:7 رسلنا — طلب مباشر: ق أخضر
      '43:45:7': true,
      // 77:23:1 فقدرنا — طلب مباشر: ق أخضر (+ تجاوز صلي)
      '77:23:1': true,
      // 2:25:31 مطهرة — طلب مباشر: ق أخضر (+ تجاوز لا)
      '2:25:31': true,
      // 39:8:30 قليلا — طلب مباشر: ق أخضر (+ تجاوز صلي)
      '39:8:30': true
    ...
    'SAD_RUKHSA': {
      ...
      // طلب مباشر 1.0.748: لذنوبهم قف→ص مرخص (أخضر)
      '3:135:11': true
    },
  ...
  // استثناءات صريحة من سياسة لا/صلي العامة أعلاه (DEFAULT_MARK_LA_SILA_BLOCK)
  // — طلب مباشر لكل حالة على حدة، منفصلة تمامًا عن الجدول اليدوي
  // العام (DEFAULT_MARK_MANUAL_EXCLUSIONS) وتُفحص قبل تفعيل هذه
  // السياسة في buildDefaultWordMap أدناه مباشرة. كل إدخال هنا قرار
  // مراجعة موثّق يسمح بنوع علامة محدد عند كلمة بعينها رغم وجودها في
  ...
  var DEFAULT_MARK_LA_SILA_OVERRIDES = {
    ...
    // 96:12:3 بالتقوى: خامها لا؛ طلب مباشر ط أزرق.
    '96:12:3': { TA_MUTLAQ: true },
    // 2:25:31 مطهرة: خامها لا + ق؛ طلب مباشر ق أخضر.
    '2:25:31': { QAD_QILA: true },
    // 2:256:4 الدين: خامها لا + قف؛ طلب مباشر قف بني.
    '2:256:4': { QIF: true },
    // 6:19:7 الله (قل الله): خامها لا + قف؛ طلب مباشر قف بني.
    '6:19:7': { QIF: true },
    // 6:141:25 حصاده: عليها صلي + ز؛ طلب مباشر ز أخضر.
    '6:141:25': { ZAY_JAWAZ: true },
    // 7:151:8 رحمتك: عليها صلي + ز؛ طلب مباشر ز أخضر.
    '7:151:8': { ZAY_JAWAZ: true },
    // 4:140:22 غيره: عليها صلي + ز؛ طلب مباشر ز أخضر.
    '4:140:22': { ZAY_JAWAZ: true },
    // 2:168:8 طيبا: عليها صلي + ز؛ طلب مباشر ز أخضر.
    '2:168:8': { ZAY_JAWAZ: true },
    // 9:17:14 أعمالهم: عليها صلي + ج؛ طلب مباشر ج بني.
    '9:17:14': { JEEM: true },
    // 12:29:6 لذنبك: عليها صلي + ج؛ طلب مباشر ج بني.
    '12:29:6': { JEEM: true },
    // 2:89:16 كفروا — طلب مباشر: اعتماد ج بني رغم صلي في مصحف المدينة.
    '2:89:16': { JEEM: true },
    // 39:8:30 قليلا: عليها صلي + ق؛ طلب مباشر ق أخضر.
    '39:8:30': { QAD_QILA: true },
    // 5:20:15 ("مُّلُوكٗا"): عليها صلي في النسخ + ق في المدينة؛ طلب مباشر ق أخضر.
    '5:20:15': { QAD_QILA: true },
    // 77:23:1 فقدرنا: عليها صلي في النسخ + ق؛ طلب مباشر ق أخضر (تجاوز لا/صلي).
    '77:23:1': { QAD_QILA: true },
    // 10:22:34 ("ٱلدِّينَ"): عليها لا في النسخ + رأس غير كوفيين أخضر؛ طلب مباشر ج بني
    // مع إزالة لا واللون الأخضر عن الرأس (NON_KUFI → عارٍ).
    '10:22:34': { JEEM: true },
    // 31:32:9 ("ٱلدِّينَ"): مخلصين له الدين — لا في النسخ + رأس غير كوفيين أخضر؛
    // طلب مباشر ج بني + رأس غير الكوفيين [ج] (لا/أخضر → ج/بني).
    '31:32:9': { JEEM: true },
    // 33:60:19 قليلا: عليها صلي في النسخ + ج؛ طلب مباشر ج بني (تجاوز لا/صلي).
    '33:60:19': { JEEM: true },
    // 20:86:6 أسفا: عليها لا؛ طلب مباشر ج بني + إزالة لا عن الرأس.
    '20:86:6': { JEEM: true },
    // 20:86:13 حسنا: عليها لا؛ طلب مباشر ط أزرق + إزالة لا عن الرأس.
    '20:86:13': { TA_MUTLAQ: true },
    // 26:49:14 تعلمون: عليها لا؛ طلب مباشر ط أزرق + رأس غير الكوفيين [ط].
    '26:49:14': { TA_MUTLAQ: true },
    ...
    // DEFAULT_MARK_MANUAL_EXCLUSIONS['JEEM'] أعلاه) يعتمد وقفًا جائزًا ج
    // هنا بناءً على مصحف النسخ نفسه لهذا الموضع تحديدًا فقط — إزالتها
    // من الجدول اليدوي وحدها (1.0.660) لم تكن كافية لأن هذه الطبقة
    // الأسبق (لا/صلي العامة) كانت لا تزال تستبعدها قبل الوصول لذلك
    // الجدول؛ هذا الإدخال يتجاوز تلك الطبقة لنوع JEEM فقط عند هذه
    // الكلمة تحديدًا.
    '3:30:9': { JEEM: true },
    // 29:60:9 ("وَإِيَّاكُمۡ"): تحمل صلي فعليًا في مصحف النسخ (موجودة في
    // SILA_POSITIONS)، فكانت تُستبعد تلقائيًا من DEFAULT_MARK_LA_SILA_BLOCK
    // (وأيضًا عبر إدخال يدوي مطابق في DEFAULT_MARK_MANUAL_EXCLUSIONS['ZAY_JAWAZ']،
    // حُذف الآن). عليها فعليًا علامتان في مصحف النسخ نفسه — صلي وز معًا —
    // واعتماد الوقف ز عليها استثناء صريح موثّق لهذا الموضع تحديدًا (تُلوَّن
    // أخضر)، بنفس نمط استثناء 3:30:9 أعلاه.
    '29:60:9': { ZAY_JAWAZ: true },
    // ============================================================
    // دفعة 1.0.666 — استثناءات صلي×سجاوندي لمواضع لها علامة وقف عثمانية
    // غير صلي (ۚ وأمثالها) في مصحف المدينة. المعيار: الموضع مهمَل بسبب
    // صلي في النسخ، لكن عليه علامة مدينة غير ۖ، فاعتُمد تلوين درجة وقف
    // النسخ (ج بني / ز وق أخضر) في مصحف المدينة. أُزيلت من
    // DEFAULT_MARK_MANUAL_EXCLUSIONS لنوعها، وأُضيفت هنا لتجاوز طبقة
    // DEFAULT_MARK_LA_SILA_BLOCK.
    // ============================================================
    // ج (بني)
    '2:236:13': { JEEM: true },
    '3:167:3': { JEEM: true },
    ...
    '33:44:4': { JEEM: true },
    // ز (أخضر)
    '8:69:5': { ZAY_JAWAZ: true },
    '21:45:4': { ZAY_JAWAZ: true },
    // ق (أخضر)
    '3:193:10': { QAD_QILA: true },
    '13:35:16': { QAD_QILA: true },
    '14:40:6': { QAD_QILA: true },
    '18:18:4': { QAD_QILA: true },
    '18:64:5': { QAD_QILA: true },
    '60:1:32': { QAD_QILA: true },
    // ============================================================
    // دفعة 1.0.667 — مواضع صلي×سجاوندي اتفق القراء الأربعة (الحصري،
    // المنشاوي، عبدالباسط، جبريل) على وجود وقف واضح عندها في التحليل
    // الصوتي التقديري لملفات EveryAyah. تُلوَّن بدرجة وقف النسخ.
    // ============================================================
    // ج (بني)
    '33:19:2': { JEEM: true },
    '38:5:4': { JEEM: true },
    '42:31:5': { JEEM: true },
    // ز (أخضر)
    '33:23:15': { ZAY_JAWAZ: true },
    // ق (أخضر)
    '38:65:4': { QAD_QILA: true },
    // ============================================================
    // دفعة 1.0.668 — الحديد 57:19
    // • الصِّدِّيقُونَ (57:19:7): اعتماد ق (قد قيل) خضراء — طلب مباشر
    //   بعد مراجعة سماعية؛ كانت مستبعدة بسبب صلي.
    // ============================================================
    '57:19:7': { QAD_QILA: true },
    // ============================================================
    // دفعة 1.0.669 — اعتماد مواضع 16–33 من قائمة مرجّح (≥1 قارئ)
    // بعد مراجعة المستخدم واعتمادها بالكامل. تُلوَّن بدرجة وقف النسخ.
    // ============================================================
    // ق (أخضر)
    '22:36:9': { QAD_QILA: true },
    '23:18:8': { QAD_QILA: true },
    '23:72:6': { QAD_QILA: true },
    '24:33:21': { QAD_QILA: true },
    '25:65:7': { QAD_QILA: true },
    '28:19:18': { QAD_QILA: true },
    // ص (أخضر)
    '24:22:15': { SAD_RUKHSA: true },
    // ز (أخضر)
    '35:3:19': { ZAY_JAWAZ: true },
    '35:8:15': { ZAY_JAWAZ: true },
    // ج (بني)
    '38:6:8': { JEEM: true },
    '40:64:17': { JEEM: true },
    '47:26:12': { JEEM: true },
    '50:16:8': { JEEM: true },
    // ============================================================
    // دفعة 1.0.671 — اعتماد مواضع 1–15 عدا 4 و11
    // مستبعدان: 6:141:25 (#4)، 12:29:6 (#11)
    // ============================================================
    // ج (بني)
    '2:24:11': { JEEM: true },
    '2:221:28': { JEEM: true },
    ...
    '21:32:4': { JEEM: true },
    // ز (أخضر)
    '6:146:26': { ZAY_JAWAZ: true },
    '7:154:7': { ZAY_JAWAZ: true },
    '7:179:7': { ZAY_JAWAZ: true },
    '7:196:6': { ZAY_JAWAZ: true },
    '11:16:8': { ZAY_JAWAZ: true },
    // ق (أخضر)
    '11:46:10': { QAD_QILA: true },
    '17:73:10': { QAD_QILA: true },
    '18:18:9': { QAD_QILA: true },
    '19:6:5': { QAD_QILA: true },
    // ============================================================
    // دفعة 1.0.675 — المزمل 73:20
    // ============================================================
    // 73:20:48 ("ٱللَّهِۖ" من "وَءَاخَرُونَ يُقَٰتِلُونَ فِي سَبِيلِ
    // ٱللَّهِ"): تحمل صلى فعليًا في مصحف المدينة (ۖ)، وعليها أيضًا علامة
    // ز (وقف جائز) في مصحف النسخ، فكانت مُستبعدة تلقائيًا عبر
    // DEFAULT_MARK_LA_SILA_BLOCK ضمن دفعة استبعاد تقاطع ز×صلي العامة.
    // طلب مباشر لاحق يعتمد وقف ز هنا تحديدًا (تُلوَّن أخضر بدرجة الوقف
    // ز في مصحف المدينة)، بنفس نمط استثناء 29:60:9 أعلاه: إزالة
    // الاستبعاد اليدوي المقابل من DEFAULT_MARK_MANUAL_EXCLUSIONS['ZAY_JAWAZ']
    // وإضافة هذا الإدخال لتجاوز طبقة DEFAULT_MARK_LA_SILA_BLOCK.
    '73:20:48': { ZAY_JAWAZ: true },
    // ============================================================
    // دفعة 1.0.676 — استثناء 11 موضع صلي×سجاوندي (من جدول المراجعة)
    // عليها علامة صلي في مصحف النسخ، وتُستثنى من قاعدة لا/صلي العامة
    // لتُلوَّن في مصحف المدينة بدرجة وقف النسخ (ج بني / ز وق أخضر).
    // أُزيلت من DEFAULT_MARK_MANUAL_EXCLUSIONS لنوعها، وأُضيفت هنا
    // لتجاوز طبقة DEFAULT_MARK_LA_SILA_BLOCK.
    // ============================================================
    // ج (بني)
    '2:133:24': { JEEM: true },
    '13:39:5': { JEEM: true },
    ...
    '78:40:4': { JEEM: true },
    // ز (أخضر)
    '4:141:13': { ZAY_JAWAZ: true },
    '9:52:18': { ZAY_JAWAZ: true },
    '35:13:11': { ZAY_JAWAZ: true },
    '46:26:11': { ZAY_JAWAZ: true },
    // ق (أخضر)
    '39:23:7': { QAD_QILA: true },
    '58:1:11': { QAD_QILA: true },
    // ============================================================
    // دفعة 1.0.739 — اعتماد مواضع قف/ق بعد مراجعة مباشرة
    // ============================================================
    // 78:38:5 صفا: خامها لا+ق+ط؛ طلب مباشر ق أخضر
    '78:38:5': { QAD_QILA: true },
    // 14:27:14 الظالمين: خامها لا+قف؛ طلب مباشر قف بني
    '14:27:14': { QIF: true },
    // 37:31:4 ربنا: عليها صلي في النسخ + ق؛ طلب مباشر ق أخضر
    '37:31:4': { QAD_QILA: true }
  };
  ...
  function buildDefaultWordMap(waqfType){
    ...
    for(var i = 0; i < positions.length; i++){
      ...
      // — إلا إذا وُجد استثناء صريح موثّق لهذا النوع تحديدًا عند هذه
      // الكلمة في DEFAULT_MARK_LA_SILA_OVERRIDES (يُفحص قبل الاستبعاد).
  ...
  //     الصلي، لا تكرار)، وموضع واحد (47:4:20) محسوم مسبقًا. 33:13:21
  //     كانت مُستبعدة هنا سابقًا لتعارضها مع قرار ط، لكن ذلك القرار
  //     أُلغي لاحقًا لصالح ج (راجع UPDATE أعلى DEFAULT_MARK_MANUAL_ADDITIONS
  //     وفوق جدول ج مباشرة) — فهي الآن ضمن الـ25 التي حُسمت بمطابقة
  //     مصحف النسخ، لا ضمن المستبعدات. الباقي 25
