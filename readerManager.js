...
(function(){
  ...
  // هذه المرة صراحةً وبتأكيد مباشر متكرر: "قف وليس ق". أزرق، نفس لون
  // .waqf-mark.mark-blue بالضبط (#1565C0 نهاري / #64B5F6 ليلي — طلب
  // مباشر، نفس لون ط). تُستبعد عند آخر كلمة في الآية (طلب مباشر صريح).
  //
  // فحص التعارض:
